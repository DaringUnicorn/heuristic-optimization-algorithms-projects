...
def test_on_different_graph(graph_file="gc_70_9.txt"):
    """
    Test all four hybrid algorithms on a different graph file.
    """
    ...
    print("=" * 80)
    print(f"Testing ALL FOUR Hybrid Algorithms on {graph_file}")
    print("=" * 80)
    ...
    try:
        ...
        # Test parameters
        population_size = 30  # Smaller population for larger graphs
        generations = 30      # Fewer generations for faster testing
        ...
        ga_ts = GATabuSearch(
            ...
            tabu_iterations=500,  # Reduced for larger graphs
            tabu_tenure=10
        )
        ...
        memetic_ga = MemeticGA(
            ...
            local_search_iterations=20  # Reduced for larger graphs
        )
        ...
        ga_greedy_custom = GAGreedyCustomCrossover(
            ...
            population_size=population_size,
            num_colors=num_colors,
            local_search_iterations=15  # Reduced for larger graphs
        )
...
if __name__ == "__main__":
    # Test with gc_100_9.txt
    results = test_on_different_graph("gc_70_9.txt")
